...
if(isset($_POST['submit'])) {
    ...
    include_once('config.php');
     ...
     if (isset($_FILES['foto'])) {
        ...
        // Mova o arquivo temporário para o local desejado no servidor
        move_uploaded_file($foto_temp, 'caminho/para/salvar/fotos/' . $foto_nome);

        // Salve o nome do arquivo no banco de dados (ou faça o que for necessário)
        // ...
    }
 
     $result = mysqli_query($conexao, "INSERT INTO cadastro(nome, sexo,porte, castrado, vermifugado,doenca, idade, descricao, entrada, saida) VALUES ('$nome','$sexo','$porte','$castrado', '$vermifugado','$doenca','$idade','$descricao','$entrada', '$saida')");
