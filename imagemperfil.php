...
// Calcule a posição para centralizar a letra verticalmente
$bbox = imagettfbbox($tamanhoFonte, 0, $fonte, $primeiraLetra);
$x = ($largura - $bbox[4]) / 2;
$y = ($altura + $bbox[5]) / 2; // Ajuste para centralizar verticalmente

// Escreva a primeira letra no centro da imagem
imagettftext($imagem, $tamanhoFonte, 0, $x, $y, $corTexto, $fonte, $primeiraLetra);
